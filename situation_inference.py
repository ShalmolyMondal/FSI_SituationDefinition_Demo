...
def predictTraffic(density, speed=None):
    ...
    generated_memberfunctiondata_density = list(
        density_membership_data["member_data"])
    generated_memberfunctiondata_speed = list(
        speed_membership_data["member_data"])
    if (
        ...
        if fuzzyness_density == "low" and fuzzyness_speed == "normal":
            print(
                ...
                # print ("Speed Values generated are :" , "and density values generated are:") //values should be generated for low traffic situation (low density values and normal speed values)
            )
